...
export default function SinglePost() {
    ...
    return (
        <main className="bg0gray-200 min-h-screen p-12">
            <article className="container shadow-lg mx-auto bg-green-100 rounded-lg">
                <header className="relative">
                    <div className="w-full h-full absolute flex justify-center items-center p-8">
                ...
                <div className="px-16 lg:px-48 py-12 lg:py-12 prose lg:prose-xl max-w-full">
                    <BlockContent blocks={singlePost.body} projectId="9cn2ty1c" dataset="production" />
                </div>
            </article>
        </main>
    )
